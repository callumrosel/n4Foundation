...
define(['baja!',
  ...
  describe('nmodule/n4Foundation/rc/N4FoundationWidget', function () {
    var stooges,
        widget,
        elem;
    ...
    describe('#doInitialize()', function () {
      it('creates the structure to load buttons into', function () {
        expect(elem.find('.N4FoundationWidget-header').length).toBe(1);
        expect(elem.find('.N4FoundationWidget-content').length).toBe(1);
      });

      it('arms a handler to set active class on button click', function () {
        var contentDom = elem.find('.N4FoundationWidget-content'),
      ...
      it('arms a handler to display selected slot name', function () {
        var slotDom = elem.find('.N4FoundationWidget-selected-slot');

        runs(function () {
          var contentDom = elem.find('.N4FoundationWidget-content'),
              button = $('<button class="N4FoundationWidget-button" data-slot="curlyJoe"></button>');
